...
import MdxPage from "../../../../pages/docs/concepts/transaction_model.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/concepts/transaction_model";

export const Route = createFileRoute("/docs/concepts/transaction_model")({
  head: () => {
