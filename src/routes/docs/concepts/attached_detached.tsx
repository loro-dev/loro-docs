...
import MdxPage from "../../../../pages/docs/concepts/attached_detached.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/concepts/attached_detached";

export const Route = createFileRoute("/docs/concepts/attached_detached")({
  head: () => {
