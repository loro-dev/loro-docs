...
import MdxPage from "../../../../pages/docs/concepts/version_vector.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/concepts/version_vector";

export const Route = createFileRoute("/docs/concepts/version_vector")({
  head: () => {
