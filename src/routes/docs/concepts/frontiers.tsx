...
import MdxPage from "../../../../pages/docs/concepts/frontiers.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/concepts/frontiers";

export const Route = createFileRoute("/docs/concepts/frontiers")({
  head: () => {
