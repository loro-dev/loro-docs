...
import MdxPage from "../../../../pages/docs/performance/native.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/performance/native";

export const Route = createFileRoute("/docs/performance/native")({
  head: () => {
