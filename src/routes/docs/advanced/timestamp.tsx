...
import MdxPage from "../../../../pages/docs/advanced/timestamp.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/advanced/timestamp";

export const Route = createFileRoute("/docs/advanced/timestamp")({
  head: () => {
