...
import MdxPage from "../../../../pages/docs/advanced/inspector.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/advanced/inspector";

export const Route = createFileRoute("/docs/advanced/inspector")({
  head: () => {
