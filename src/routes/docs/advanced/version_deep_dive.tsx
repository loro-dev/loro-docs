...
import MdxPage from "../../../../pages/docs/advanced/version_deep_dive.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/advanced/version_deep_dive";

export const Route = createFileRoute("/docs/advanced/version_deep_dive")({
  head: () => {
