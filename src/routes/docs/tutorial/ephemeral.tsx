...
import MdxPage from "../../../../pages/docs/tutorial/ephemeral.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/tutorial/ephemeral";

export const Route = createFileRoute("/docs/tutorial/ephemeral")({
  head: () => {
