...
import MdxPage from "../../../../pages/docs/tutorial/time_travel.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/tutorial/time_travel";

export const Route = createFileRoute("/docs/tutorial/time_travel")({
  head: () => {
