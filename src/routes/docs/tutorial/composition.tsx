...
import MdxPage from "../../../../pages/docs/tutorial/composition.mdx";
import { ContentPage } from "../../../components/ContentPage";
import { getContentEntry } from "../../../generated/content-manifest";
import { buildRouteHead } from "../../../lib/route-head";

const routePath = "/docs/tutorial/composition";

export const Route = createFileRoute("/docs/tutorial/composition")({
  head: () => {
