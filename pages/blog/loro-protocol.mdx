...
The **Loro Protocol** ([GitHub Link](https://github.com/loro-dev/protocol)) is a wire protocol designed for real-time CRDT synchronization. Learn about the design [here](https://github.com/loro-dev/protocol/blob/main/protocol.md).
...
The core packages are open-sourced under the permissive MIT license:
