...
![Regular child containers derive identity from creation operations, while mergeable containers derive identity from logical path](/images/blog-mergeable-containers-flow.png)
