...
<Author
  name="Zixuan Chen"
  link="https://twitter.com/zx_loro"
/>
...
<aside>
**Application-level version-control responsibilities**
...
At the time of Loro 1.0, Loro's storage implementation used get, set, and range operations of
...
At the time of Loro 1.0, we still needed to load the entire document blob into memory. However, the architecture already had internal block-based loading and storage, making it easier to implement true block-based retrieval and saving from disk in the future. This could make Loro function more like a database. While theoretically feasible, we planned to assess whether practical scenarios required this capability. For most documents, Loro's performance was already quite sufficient.
...
Below is a historical comparison of Snapshot import and export speeds between
Loro versions 1.0.0-beta.1 and 0.16.12. The benchmark is based on document editing history
