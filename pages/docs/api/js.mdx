...
- Jump quickly to major sections. For a guided walkthrough and practical examples, see [Getting Started with LoroDoc](/docs/tutorial/loro_doc) and [Examples](/docs/examples).
...
Import/export updates for sync over any transport. See [Sync Tutorial](/docs/tutorial/sync) and [Encoding & Export Modes](/docs/tutorial/encoding) for end-to-end patterns and formats.
...
Local undo operates on your own changes without breaking collaboration. See [Undo/Redo](/docs/advanced/undo) for design details 
and caveats in collaborative settings.
...
Small helpers for type checks and IDs. For more, see [Container IDs](/docs/advanced/cid) and the [Versioning Deep Dive](/docs/advanced/version_deep_dive) for frontiers/version encoding.
