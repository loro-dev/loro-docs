...
const doc = new LoroDoc();
// ---cut---
doc.setPeerId(peer: PeerID): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.setRecordTimestamp(auto_record: boolean): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.setChangeMergeInterval(interval: number): void
```
...
```ts twoslash
import { LoroDoc, StyleConfig } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.configTextStyle(styles: StyleConfig): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.getText(name: string): LoroText
```
...
const doc = new LoroDoc();
// ---cut---
doc.getList(name: string): LoroList
```
...
const doc = new LoroDoc();
// ---cut---
doc.getMap(name: string): LoroMap
```
...
const doc = new LoroDoc();
// ---cut---
doc.getTree(name: string): LoroTree
```
...
```ts twoslash
import { LoroDoc, LoroCounter } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.getCounter(name: string): LoroCounter
```
...
const doc = new LoroDoc();
// ---cut---
doc.getMovableList(name: string): LoroMovableList
```
...
```ts twoslash
import { LoroDoc, ContainerID, Container } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.getContainerById(id: ContainerID): Container | undefined
```
...
```ts twoslash
import { LoroDoc, ExportMode } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.export(mode?: ExportMode): Uint8Array
```
...
const doc = new LoroDoc();
// ---cut---
doc.import(data: Uint8Array | LoroDoc): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.importBatch(data: Uint8Array[]): void
```
...
```ts twoslash
import { LoroDoc, VersionVector, JsonSchema } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.exportJsonUpdates(start?: VersionVector, end?: VersionVector): JsonSchema
```
...
const doc = new LoroDoc();
// ---cut---
doc.importJsonUpdates(json: string | JsonSchema): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.checkout(frontiers: Frontiers): void
```
...
const doc = new LoroDoc();
// ---cut---
doc.forkAt(frontiers: Frontiers): LoroDoc
```
...
const doc = new LoroDoc();
// ---cut---
doc.subscribe(listener: (event: LoroEventBatch) => void): () => void
```
...
const doc = new LoroDoc();
// ---cut---
doc.subscribeLocalUpdates(f: (bytes: Uint8Array) => void): () => void
```
...
const doc = new LoroDoc();
// ---cut---
doc.subscribeFirstCommitFromPeer(f: (e: { peer: PeerID }) => void): () => void
```
...
const doc = new LoroDoc();
// ---cut---
doc.commit(options?: { origin?: string, message?: string, timestamp?: number }): void
```
...
```ts twoslash
import { LoroDoc, Value } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.toJSON(): Value
```
...
```ts twoslash
import { LoroDoc, Frontiers, ContainerID, Diff, JsonDiff } from "loro-crdt";
const doc = new LoroDoc();
// ---cut---
doc.diff(from: Frontiers, to: Frontiers, for_json?: boolean): [ContainerID, Diff | JsonDiff][]
```
...
const text = doc.getText("text");
// ---cut---
text.insert(index: number, text: string): void
```
...
const text = doc.getText("text");
// ---cut---
text.delete(index: number, len: number): void
```
...
```ts twoslash
import { LoroDoc, LoroText, Value } from "loro-crdt";
const doc = new LoroDoc();
const text = doc.getText("text");
// ---cut---
text.mark(range: { start: number, end: number }, key: string, value: Value): void
```
...
const text = doc.getText("text");
// ---cut---
text.update(text: string, options?: { retain?: boolean }): void
```
...
```ts twoslash
import { LoroDoc, LoroText, Cursor, Side } from "loro-crdt";
const doc = new LoroDoc();
const text = doc.getText("text");
// ---cut---
...
```ts twoslash
import { LoroDoc, LoroList, Value, Container } from "loro-crdt";
const doc = new LoroDoc();
const list = doc.getList("list");
// ---cut---
list.insert(pos: number, value: Value | Container): void
```
...
```ts twoslash
import { LoroDoc, LoroList, Container } from "loro-crdt";
const doc = new LoroDoc();
const list = doc.getList("list");
// ---cut---
list.insertContainer<T extends Container>(pos: number, container: T): T
```
...
const list = doc.getList("list");
// ---cut---
list.push(value: Value | Container): void
```
...
const list = doc.getList("list");
// ---cut---
list.pushContainer<T extends Container>(container: T): T
```
...
const list = doc.getList("list");
// ---cut---
list.pop(): Value | Container | undefined
```
...
const list = doc.getList("list");
// ---cut---
list.get(index: number): Value | Container | undefined
```
...
```ts twoslash
import { LoroDoc, LoroList, Cursor, Side } from "loro-crdt";
const doc = new LoroDoc();
const list = doc.getList("list");
// ---cut---
list.getCursor(pos: number, side?: Side): Cursor | undefined
```
...
```ts twoslash
import { LoroDoc, LoroMap, Value, Container } from "loro-crdt";
const doc = new LoroDoc();
const map = doc.getMap("map");
// ---cut---
map.set(key: string, value: Value | Container): void
```
...
```ts twoslash
import { LoroDoc, LoroMap, Container } from "loro-crdt";
const doc = new LoroDoc();
const map = doc.getMap("map");
// ---cut---
map.setContainer<T extends Container>(key: string, container: T): T
```
...
const map = doc.getMap("map");
// ---cut---
map.get(key: string): Value | Container | undefined
```
...
const map = doc.getMap("map");
// ---cut---
map.getOrCreateContainer<T extends Container>(key: string, container: T): T
```
...
const map = doc.getMap("map");
// ---cut---
map.entries(): [string, Value | Container][]
```
...
// ---cut---
tree.createNode(parent?: TreeID, index?: number): TreeID
```
...
const tree = doc.getTree("tree");
// ---cut---
tree.move(target: TreeID, parent?: TreeID, index?: number): void
```
...
const tree = doc.getTree("tree");
// ---cut---
tree.delete(target: TreeID): void
```
...
```ts twoslash
import { LoroDoc, LoroTree, TreeID, LoroTreeNode } from "loro-crdt";
const doc = new LoroDoc();
const tree = doc.getTree("tree");
// ---cut---
tree.getNodeByID(id: TreeID): LoroTreeNode | undefined
```
...
const tree = doc.getTree("tree");
// ---cut---
tree.has(target: TreeID): boolean
```
...
const tree = doc.getTree("tree");
// ---cut---
tree.isNodeDeleted(target: TreeID): boolean
```
...
```ts twoslash
import { LoroDoc, LoroTreeNode, LoroMap } from "loro-crdt";
const doc = new LoroDoc();
const tree = doc.getTree("tree");
const root = tree.createNode();
...
```ts twoslash
import { LoroDoc, LoroTreeNode, TreeID } from "loro-crdt";
const doc = new LoroDoc();
const tree = doc.getTree("tree");
const root = tree.createNode();
const node = tree.getNodeByID(root)!;
// ---cut---
node.createNode(index?: number): TreeID
```
...
const node = tree.getNodeByID(root)!;
// ---cut---
node.move(parent?: LoroTreeNode, index?: number): void
```
...
const newParentNode = tree.getNodeByID(parent)!;
// ---cut---
...
const node = tree.getNodeByID(root)!;
// ---cut---
node.moveAfter(target: LoroTreeNode): void
```
...
const siblingNode = tree.getNodeByID(sibling)!;
// ---cut---
...
const node = tree.getNodeByID(root)!;
// ---cut---
node.moveBefore(target: LoroTreeNode): void
```
...
// ---cut---
counter.increment(value?: number): void
```
...
const counter = doc.getCounter("counter");
// ---cut---
counter.decrement(value?: number): void
```
...
// ---cut---
movableList.move(from: number, to: number): void
```
...
```ts twoslash
import { LoroDoc, LoroMovableList, Value, Container } from "loro-crdt";
const doc = new LoroDoc();
const movableList = doc.getMovableList("list");
// ---cut---
movableList.set(pos: number, value: Value | Container): void
```
...
```ts twoslash
import { LoroDoc, LoroMovableList, Container } from "loro-crdt";
const doc = new LoroDoc();
const movableList = doc.getMovableList("list");
// ---cut---
movableList.setContainer<T extends Container>(pos: number, container: T): T
```
...
// ---cut---
// Track sync state
let lastSyncVersion = new Map<string, VersionVector>();

// Sync only necessary updates
function syncWithPeer(peerId: string, peerDoc: LoroDoc) {
...
const author = metadata.get("author") as LoroMap;
author.set("name", "Alice");
author.set("id", "user-123");
```
...
declare const handler: (event: any) => void;
// ---cut---
...
```ts twoslash
import { LoroDoc, UndoManager, isContainerId } from "loro-crdt";
const doc = new LoroDoc();
const undo = new UndoManager(doc);
declare const unknownData: Uint8Array;
...
const doc = new LoroDoc();
const text = doc.getText("text");
declare const newContent: string;
let pos = 0;
// ---cut---
...
// doc.subscribe((event) => {
//   if (event.currentTarget === container.id) {
//     // Handle change
//   }
// });
```
