...
- Hierarchical trees: [`getTree`](#LoroDoc.getTree) for file systems, nested comments
- Reorderable lists: [`getMovableList`](#LoroDoc.getMovableList) with [`move`](#LoroMovableList.move)
