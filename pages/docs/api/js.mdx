...
<Method id="EphemeralStoreWasm.constructor">
```typescript
...
**Parameters:**
- `timeout` - Duration in milliseconds. A peer's state is considered outdated if its last update is older than this timeout.

**Example:**
```ts twoslash
import { EphemeralStoreWasm } from "loro-crdt";

// Create ephemeral store with 30 second timeout
const store = new EphemeralStoreWasm(30000);
```
</Indent>

<Method id="EphemeralStoreWasm.set">
```typescript
...
<Method id="EphemeralStoreWasm.get">
```typescript
get(key: string): any
```
</Method>
...
<Method id="EphemeralStoreWasm.delete">
```typescript
delete(key: string): void
```
</Method>
...
<Method id="EphemeralStoreWasm.getAllStates">
```typescript
getAllStates(): any
```
</Method>
...
<Method id="EphemeralStoreWasm.encode">
```typescript
...
<Method id="EphemeralStoreWasm.encodeAll">
```typescript
...
<Method id="EphemeralStoreWasm.apply">
```typescript
...
**Parameters:**
- `data` - Encoded updates from remote peer
...
<Method id="EphemeralStoreWasm.removeOutdated">
```typescript
removeOutdated(): void
```
</Method>
<Indent>
Remove outdated states based on the timeout.
...
<Method id="EphemeralStoreWasm.isEmpty">
```typescript
isEmpty(): boolean
```
</Method>
...
<Method id="EphemeralStoreWasm.keys">
```typescript
keys(): string[]
```
</Method>
