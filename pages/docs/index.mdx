...
description: Learn how Loro CRDTs make local-first and real-time collaborative apps easy — sync, version history, rich text, and conflict-free merges with a simple API.
---
