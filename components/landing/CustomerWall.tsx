...
export default function CustomerWall(): JSX.Element {
  const { customerWall } = useHomeTranslations();

  return (
    <section className="px-5 md:px-15 mt-32 z-10 relative">
      <div className="text-center mb-20">
        <h2
          className="text-4xl md:text-5xl not-italic font-bold bg-clip-text mb-8 bg-blue-green text-fill-transparent"
          style={{ lineHeight: 1.5 }}
        >
          {customerWall.heading}
        </h2>
      </div>
