// Since Shiki highlighting happens at build time during MDX compilation,
// we need to use a different approach for runtime code blocks.
// This component provides a wrapper that mimics Nextra's code block styling
// while allowing dynamic code content.
...
export function CodeBlock({ 
  ...
  // For string content, we need to render it with Nextra's styling
  // but without Shiki highlighting (since that happens at build time)
